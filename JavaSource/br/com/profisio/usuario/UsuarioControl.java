...
public class UsuarioControl extends ControllerBase {
	...
	private void registrarUsuario(Usuario usuario) {
		if (this.dao.rodarTour(usuario.getTenant()))
			usuario.getTenant().setTour(true);
		else
			usuario.getTenant().setTour(false);
	...
	public void tour() {
		...
		registrarUsuario(ProfisioSessionUtil.getUserSession());
	}
}
