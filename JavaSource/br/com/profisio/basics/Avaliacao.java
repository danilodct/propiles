...
public class Avaliacao extends ObjetoBasico {
	...
	public String getPesoStr() {
		return SystemUtils.parseDoubleToString(peso);
	}
	...
	public void setPesoStr(String peso) {
		this.peso = SystemUtils.parseStringDouble(peso);
	}
	...
	public String getAlturaStr() {
		return SystemUtils.parseDoubleToString(altura);
	}
	...
	public void setAlturaStr(String altura) {
		this.altura = SystemUtils.parseStringDouble(altura);
	}
