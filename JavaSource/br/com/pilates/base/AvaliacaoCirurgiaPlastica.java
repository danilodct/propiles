...
public class AvaliacaoCirurgiaPlastica extends Avaliacao {

	private String cirurgiaPlastica;
	private String medicoAcompanhante;
	private String atoCirurgico;
	private String edema;
	private String equimose;
	private String fibrose;
	private String fpo;
	private String seroma;
	private String descenciaCirurgica;
	...
	public AvaliacaoCirurgiaPlastica() {
	}

	public String getCirurgiaPlastica() {
		return cirurgiaPlastica;
	}

	public void setCirurgiaPlastica(String cirurgiaPlastica) {
	...
	public String getAtoCirurgico() {
		return atoCirurgico;
	}

	public void setAtoCirurgico(String atoCirurgico) {
		this.atoCirurgico = atoCirurgico;
	}
	...
	public String getEquimose() {
		return equimose;
	}

	public void setEquimose(String equimose) {
		this.equimose = equimose;
	}
	...
	public void setFibrose(String fibrose) {
	...
	public String getSeroma() {
		return seroma;
	}

	public void setSeroma(String seroma) {
		this.seroma = seroma;
	}

	public String getDescenciaCirurgica() {
		return descenciaCirurgica;
	}

	public void setDescenciaCirurgica(String descenciaCirurgica) {
		this.descenciaCirurgica = descenciaCirurgica;
	}
