	...
	<tr>
		...
		<div class="formAdd hidden">
			<fieldset>
				...
				<s:form id="formInserirCadastro" action="inserirServico" method="post" enctype="multipart/form-data">
					<table class="formAdd">
...
<table class="listagem">
	...
	<s:iterator value="servicos">
		<tr class="<%= classes.get(pointer % 2) %>">
			<td><a href="servico?servico.id=<s:property value="id" />"><s:property value="nome" /> 
				<s:if test="centroCusto != null"> [<s:property value="centroCusto.nome" />] </s:if>
				</a></td>
			<td><a class="remover" href="removerServico?servico.id=<s:property value="id" />" ><img src="img/delete.gif" /></a></td>
		</tr>
	<% pointer += 1; %>
	</s:iterator>
</table>
