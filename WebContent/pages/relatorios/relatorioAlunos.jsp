	...
	<tr>
		...
		<div class="formAdd">
			<fieldset>
				...
				<s:form id="formGerarRelatorio" action="relatorioAlunos" method="post">
					<table class="formAdd">
								...
								<table>
									...
									<tr>
										<td colspan="3" align="left">
											...
											Cliente <input type="radio" name="ordenacao" value="cliente.nome" />
											Professor <input type="radio" name="ordenacao" value="modalidade.professor.nome" />
											Data de Início <input type="radio" name="ordenacao" value="dataCriacao" />
											Modalidade <input type="radio" name="ordenacao" value="modalidade.modalidade" />
										</td>
									</tr>
								</table>
							</td>
...
<br />
<h2>
	Total: <s:property value="cadastros.size" /> Clientes
...
<table class="listagem">
	...
	<s:iterator value="cadastros">
		<tr class="<%= classes.get(pointer % 2) %>">
			...
			<td>
				<s:date name="dataCriacao" format="dd/MM/yyyy" />
			</td>
			<td><s:property value="modalidade.professor.nome" /></td>
			<td><s:property value="modalidade.modalidade.valor" /></td>
		</tr>
	<% pointer += 1; %>
	</s:iterator>
</table>
