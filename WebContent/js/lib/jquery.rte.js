    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                <p>\
                    <a href='#' class='bold'><img src='css/lib/images/bold.gif' alt='bold' /></a>\
                    <a href='#' class='italic'><img src='css/lib/images/italic.gif' alt='italic' /></a>\
                </p>\
                <p>\
                    <a href='#' class='unorderedlist'><img src='css/lib/images/unordered.gif' alt='unordered list' /></a>\
                    <a href='#' class='link'><img src='css/lib/images/link.png' alt='link' /></a>\
                    <a href='#' class='image'><img src='css/lib/images/image.png' alt='image' /></a>\
                    <a href='#' class='disable'><img src='css/lib/images/close.gif' alt='close rte' /></a>\
                </p></div></div>");
